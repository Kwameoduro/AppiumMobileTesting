...
public class WaitUtils {
    ...
    public static WebElement waitForVisibility(AppiumDriver driver, By locator) {
        try {
            ...
            System.err.println("⚠️ Element not visible: " + locator + " | " + e.getMessage());
            return null;
        }
    }
    ...
    public static WebElement waitForClickable(AppiumDriver driver, By locator) {
        try {
            ...
            System.err.println("⚠️ Element not clickable: " + locator + " | " + e.getMessage());
            return null;
        }
    }
    ...
    public static WebElement waitForPresence(AppiumDriver driver, By locator) {
        try {
            ...
            System.err.println("⚠️ Element not present: " + locator + " | " + e.getMessage());
            return null;
        }
    }
    ...
    public static boolean waitForText(AppiumDriver driver, By locator, String expectedText) {
        try {
            ...
            System.err.println("⚠️ Text not found in element: " + locator + " | Expected: " + expectedText);
            return false;
        }
    }
    ...
    public static boolean waitForInvisibility(AppiumDriver driver, By locator) {
        try {
            ...
            System.err.println("⚠️ Element still visible: " + locator + " | " + e.getMessage());
            return false;
        }
    }
}

...
public class ProductsTest extends BaseTest {
    ...
    // ✅ Use classpath-relative path like in LoginTest
    ...
    @Test(groups = {"products"}, description = "Verify user can log in and land on the Products page")
    public void testSuccessfulLoginNavigatesToProductsPage() {
        loginWithValidUser();
    }

    @Test(groups = {"products"}, description = "Verify product list is displayed on Products page")
    ...
    @Test(groups = {"products"}, description = "Verify first product name and price match expected values")
    ...
    @Test(groups = {"products"}, description = "Verify sorting functionality shows available options")
    ...
    @Test(groups = {"products"}, description = "Verify user can add a product to the cart")
